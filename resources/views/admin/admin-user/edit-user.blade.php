    ...
    <div class ="stage">
        <div class="page">
            ...
            <div class="profile-card">
                <form id="edit-user-form" method="POST" action="{{ route('admin.users.update', $user) }}"
                    ...
                    <div class="profile-picture-row">
                        ...
                        <div class="profile-avatar-lg">
                            ...
                            @else
                                ...
                                <img id="profile-preview" src="" alt="Profile Preview" class="profile-image"
                                    style="display:none;">
                            @endif
                        </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field field-role">
                            ...
                            <select id="role" name="role" required>
                                <option
                                    value="Developer"{{ old('role', $user->role) === 'Developer' ? 'selected' : '' }}>
                                    Developer</option>
