                    ...
                    <table class="voucher-table">
                        ...
                        <tbody id="voucher-table-body">
                            ...
                            @foreach ($invoices as $invoice)
                                <tr class="voucher-row" data-type="invoice"
                                    ...
                                    <td>
                                        {{ $invoice->submitted_at ? $invoice->submitted_at->format('j F Y') : '-' }}
                                    </td>
                                    ...
                                    <td class="col-action">
                                        ...
                                        <a href="{{ route('admin.payment-vouchers.invoices.show', $invoice) }}"
                            ...
                            @foreach ($claims as $claim)
                                <tr class="voucher-row" data-type="claim"
                                    data-search="{{ strtolower(
                                        $claim->claim_code .
                                            ' ' .
                                            $claim->title .
                                    ...
                                    <td class="col-action">
                                        ...
                                        <a href="{{ route('admin.payment-vouchers.claims.show', $claim) }}"
                                            class="action-link" title="View request">
                                            <svg viewBox="0 0 24 24">
                                                <rect x="5" y="4" width="14" height="17" rx="2"></rect>
