...
<div class="page">
    ...
    <div class="top-row">
        <div class="title-area">
            ...
            <a href="{{ route('admin.payment-vouchers.index') }}" class="back-link">← Back to Payment Voucher Management</a>
        </div>
            ...
            <div class="panel">
                ...
                <div class="claim-info-body">
                    <div class="info-grid">
                        ...
                        @if (
                            $claim->category?->category_name === 'Other'
                ...
                <div class="panel review-panel">
                    ...
                    <div class="review-body">
                        ...
                        <div class="review-actions">
                            ...
                            <form action="{{ route('admin.payment-vouchers.claims.approve', $claim) }}" method="POST" class="review-form">
                            ...
                            <form action="{{ route('admin.payment-vouchers.claims.reject', $claim) }}" method="POST" class="review-form">
            ...
            @if ($claim->status === 'Approved' && !$claim->paymentVoucher)
                ...
                <div class="panel">
                    ...
                    <div class="voucher-body">
                        ...
                        <form action="{{ route('admin.payment-vouchers.claims.generate', $claim) }}" method="POST">
                ...
                <div class="panel review-panel">
                    ...
                    <div class="review-body">
                        ...
                        <div class="review-actions">
                            ...
                            <button type="button" class="btn btn-reject review-btn-disabled" disabled>Reject Claim</button>
                        </div>
                ...
                <div class="panel">
                    ...
                    <div class="voucher-body">
                        ...
                        <div class="voucher-actions">
                            ...
                            <button type="button" class="btn btn-outline-blue">↓ Download Voucher PDF</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel review-panel">
                    ...
                    <div class="review-body">
                        ...
                        <div class="review-actions">
                            ...
                            <button type="button" class="btn btn-approve review-btn-disabled" disabled>Approve Claim</button>
                            <button type="button" class="btn btn-reject review-btn-disabled" disabled>Reject Claim</button>
