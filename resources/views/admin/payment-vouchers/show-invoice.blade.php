        ...
        <div class="page">
            ...
            <div class="page-header-row">
                ...
                ">
                    ...
                    <a class="back-link" href="{{ route('admin.payment-vouchers.index') }}">
                            ...
                            <div>
                                ...
                                <div class="meta-block">
                                    ...
                                    <div class="meta-value">
                                        {{ $invoice->user?->fullname ?? ($invoice->user?->username ?? 'Unknown Developer') }}
                    ...
                    @if ($invoice->status === 'Submitted')
                        ...
                        <div class="card">
                            ...
                            <div class="voucher-body">
                                ...
                                <textarea class="review-notes" id="review-notes" placeholder="Enter review notes...">{{ old('notes') }}</textarea>


                                <div class="review-actions">

                                    <form action="{{ route('admin.payment-vouchers.invoices.approve', $invoice) }}"
                                    ...
                                    <form action="{{ route('admin.payment-vouchers.invoices.reject', $invoice) }}"
                                        method="POST" class="review-form">
                                        @csrf
                                        @method('PUT')
                    ...
                    @if ($invoice->status === 'Approved' && !$invoice->paymentVoucher)
                        <div class="card">
                            ...
                            <div class="voucher-body">
                                ...
                                <form action="{{ route('admin.payment-vouchers.invoices.generate', $invoice) }}"
                                    method="POST">
                                    @csrf
                                    ...
                                    <div class="voucher-field">
                                        ...
                                        <div class="payment-method-display">Bank Transfer</div>
                        ...
                        <div class="card">
                            ...
                            <div class="voucher-body">
                                ...
                                <textarea class="review-notes review-notes-readonly" readonly placeholder="No review notes provided.">{{ $invoice->review_notes }}</textarea>

                                <div class="review-actions">

                                    <button class="btn btn-approve review-btn-disabled" type="button" disabled>
                                        Approve Invoice
                                    </button>

                                    <button class="btn btn-reject review-btn-disabled" type="button" disabled>
                                        Reject Invoice
                                    </button>
                            ...
                            <div class="voucher-body">
                                ...
                                <div class="review-result">
                                    ...
                                    <div class="meta-value">
                                        ...
                                        {{ $invoice->reviewed_at ? $invoice->reviewed_at->format('F j, Y') : '-' }}
                                ...
                                <textarea class="review-notes" readonly>{{ $invoice->review_notes }}</textarea>
