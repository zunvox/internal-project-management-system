                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-field">
                                ...
                                <input id="project_name" name ="name" type="text" value="{{ old('name') }}"
                        ...
                        <div class="dev-list">
                            ...
                            @forelse ($developers as $developer)
                                <label class="dev-item" data-name="{{ strtolower($developer->fullname) }}">
                                    ...
                                    <input class="dev-checkbox" type="checkbox" name="developers[]"
                                        value="{{ $developer->id }}" data-developer-name="{{ $developer->fullname }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSelectedDevelopers() {
                ...
                if (selected.length === 0) {
                    ...
                    selectedSummary.textContent = selected.length + (selected.length === 1 ?
                        ' Developer selected -' : ' Developers selected -') + selected.join(',');
                }
            }
