                ...
                <div class="column">
                    ...
                    <div class="column-scroll">
                        ...
                        @forelse ($notStartedProjects as $project)
                            <a href="{{ route('admin.projects.edit', $project) }}" class="project-card-link"
                                ...
                                <div class="project-card">
                                    ...
                                    <div class="project-card-body">
                                        <div class="project-id">PRJ-{{ str_pad($project->id, 4, '0', STR_PAD_LEFT) }}
                                        </div>
                                        <div class="project-desc">
                                            {{ $project->description ?? 'No project description.' }}</div>
