    ...
    <div class="stage">
        <div class="frame">
            <div class="login-card">
                ...
                @if (session('status'))
                    <p id = "status-message"
                        style = "color:green; text-align:center; font-size:13px; margin-bottom:16px;">
                ...
                <form id = "login-form" method = "POST" action="{{ route('login.store') }}">
                    ...
                    <div class="field">
                        ...
                        <input id = "email" name = "email" type = "email" value = "{{ old('email') }}"
                            placeholder = "e.g syed@syedn.xyz" required>
                    </div>

                    <div class="field">
                        <label for = "password">Password</label>
                        <input id = "password" name = "password" type = "password" placeholder = "e.g hello123"
                            required>
                    </div>
