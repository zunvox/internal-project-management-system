        ...
        <div class="page">
            ...
            <div class="form-wrap">
                <div class="card">
                    ...
                    <form id="claim-create-form" action="{{ route('developer.claims.store') }}" method="POST"
                        ...
                        <div class="form-field">
                            ...
                            <input id="claim_title" name="title" type="text" value="{{ old('title') }}"
                                placeholder="For example: Client meeting lunch" required>

                            @error('title')
                                <div class="field-error">
                                    <svg viewBox="0 0 24 24">
                                        <path
                                            d="M12 2 1 21h22L12 2Zm0 15a1.2 1.2 0 1 1 0-2.4 1.2 1.2 0 0 1 0 2.4Zm1-4h-2V9h2v4Z" />
                                    </svg>
                                    {{ $message }}
                                </div>
                            @enderror
                        ...
                        <div class="form-field" id="other-category-field" style="display:none;">
                            ...
                            <input id="other_category" name="other_category" type="text"
                                value="{{ old('other_category') }}" placeholder="Enter claim category" maxlength="100">
                        ...
                        <div class="form-field">
                            ...
                            <div class="amount-input-wrap">
                                ...
                                <input id="claim_amount" name="amount" type="number" step="0.01" min="0.01"
                        ...
                        <div class="form-field">
                            ...
                            <input id="receipt" class="receipt-input" name="receipt" type="file"
                            ...
                            <label for="receipt" class="receipt-box">
                                ...
                                <span class="receipt-main">A receipt is required before this claim can be
                                    submitted</span>
                            ...
                            <div id="receipt-error" class="field-error"
                                @if (!$errors->has('receipt')) style="display:none;" @endif>
                                <svg viewBox="0 0 24 24">
                                    <path
                                        d="M12 2 1 21h22L12 2Zm0 15a1.2 1.2 0 1 1 0-2.4 1.2 1.2 0 0 1 0 2.4Zm1-4h-2V9h2v4Z" />
                                </svg>
                        ...
                        <div class="form-field">
                            ...
                            <textarea id="description" name="description" placeholder="Add any relevant details...">{{ old('description') }}</textarea>
