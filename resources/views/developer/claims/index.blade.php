    ...
    <div class="stage">
        <div class="page">
            ...
            <div class="page-heading">
                ...
                <a href="{{ route('developer.claims.create') }}" class="btn-create">
                    + New Claim
                </a>
            ...
            <div class="filter-row">
                ...
                <div class="status-tabs">
                    ...
                    <a href="{{ route('developer.claims.index') }}" class="status-tab {{ !$status ? 'active' : '' }}">
                        All Claims
                    ...
                    <a href="{{ route('developer.claims.index', ['status' => 'Submitted']) }}"
                    ...
                    <a href="{{ route('developer.claims.index', ['status' => 'Approved']) }}"
                    ...
                    <a href="{{ route('developer.claims.index', ['status' => 'Rejected']) }}"
                ...
                <div class="search-field">
                    ...
                    <input type="text" id="claim-search" placeholder="Search...">
            ...
            <div class="claim-card">
                            ...
                            @forelse ($claims as $claim)
                                <tr class="claim-row"
                                    data-search="{{ strtolower(
                                        $claim->claim_code . ' ' . $claim->title . ' ' . ($claim->category?->category_name ?? '') . ' ' . $claim->status,
                                    ) }}">
                                    ...
                                    <td>
                                        ...
                                        {{ $claim->category?->category_name ?? 'No Category' }}
                                    ...
                                    <td class="col-action">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('developer.claims.show', $claim) }}"
                                                class="action-link" title="View Claim">
                ...
                <div class="pagination-area">
                    ...
                    <button type="button" class="page-button active">
                        1
                    </button>
