                    ...
                    <div class="panel">
                        ...
                        <div class="claim-info-body">
                            <div class="info-grid">
                                ...
                                @if (optional($claim->category)->category_name === 'Other' && $claim->other_category)
                                    <div class="info-item">
                    ...
                    <div class="panel">
                        ...
                        <div class="receipt-body">
                            <div class="receipt-row">
                                ...
                                <a href="{{ asset('storage/' . $claim->receipt) }}" target="_blank"
                                    class="view-receipt">
                                    View Receipt →
                                </a>
                ...
                <div class="right-column">
                    ...
                    <div class="panel notes-panel">
                        ...
                        <div class="notes-body">
                            ...
                            <textarea class="notes-textarea" readonly placeholder="Notes from Admin...">{{ $claim->review_notes ?? '' }}</textarea>


                            @if ($claim->status === 'Rejected')
                                <a href="{{ route('developer.claims.create') }}" class="btn-new-entry">
                                    New Entry
                                </a>
                            @endif
