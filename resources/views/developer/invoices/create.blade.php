...
<body>
    ...
    <div class = "stage">
        <div class="page">
            ...
            <form action="{{ route('developer.invoices.store') }}" method="POST" enctype="multipart/form-data"
                id="invoice-form">
                ...
                <div class="columns">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="field-row">
                                <div class="form-field">
                                    ...
                                    <input id="subject" type="text" name="subject" value="{{ old('subject') }}"
                                        placeholder="e.g. Cloud Hosting & Support"required>
                                </div>
                            ...
                            <table class="items-table">
                                ...
                                <tbody id="items-body">
                                    ...
                                    <tr class="item-row">
                                        ...
                                        <td>
                                            <input type="text" name="items[0][item_name]" class="item-name"
                                                placeholder="Insert item..." required>
                                        </td>

                                        <td class="col-qty">
                                            <input type="number" name="items[0][quantity]" class="item-quantity"
                                        ...
                                        <td class="col-amount">
                                            <input type="text" class="item-total" value="RM 0.00" readonly>
                                        </td>
                                        ...
                                        <td class="col-del">
                                            ...
                                            <button class="row-delete" type="button">
                                                <svg viewBox="0 0 24 24">
                                                    <path
                                                        d="M16 9v10H8V9h8m-1.5-6h-5l-1 1H4v2h16V4h-4.5l-1-1ZM18 7H6v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7Z" />
                                                </svg>
                                            </button>
                            ...
                            <div class="form-field">
                                ...
                                <textarea id="description" name="description" placeholder="Enter additional invoice details or notes">{{ old('description') }}</textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="preview-info">
                                <div>
                                    ...
                                    <div class="value">{{ auth()->user()->fullname ?? auth()->user()->username }}
                                    </div>
                        ...
                        <div class="preview-actions">
                            <button class="btn btn-draft" type="submit" name="status" value="Draft">
                                Save as Draft
                            </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            projectInput.addEventListener('change', function() {
                ...
                previewProject.textContent = projectInput.value ? selectedOption.text :
                    'No project selected';
            ...
            itemsBody.addEventListener('input', function(event) {
                if (event.target.classList.contains('item-name') || event.target.classList.contains(
                        'item-quantity') || event.target.classList.contains('item-price')) {
                    calculateInvoice();
                }
            });
