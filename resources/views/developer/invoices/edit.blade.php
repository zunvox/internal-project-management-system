    ...
    <div class="stage">
        <div class="page">
            ...
            <div class="card">
                ...
                <form action="{{ route('developer.invoices.update', $invoice) }}" method="POST"
                    enctype="multipart/form-data" id="invoice-edit-form">
                    ...
                    @if ($errors->any())
                        <div
                            style="background:#FEE4E2; color:#B42318; padding:12px 16px; border-radius:8px; margin-bottom:16px; font-size:13px;">
                    ...
                    <div class="field-row">
                        <div class="form-field">
                            ...
                            <input id="subject" name="subject" type="text"
                                value="{{ old('subject', $invoice->subject) }}" required>
                        </div>
                                        ...
                                        <tr class="item-row">
                                            ...
                                            <td>
                                                <input type="text" name="items[{{ $index }}][item_name]"
                                                    ...
                                                    placeholder="Insert New Item..." required>
                                            </td>
                    ...
                    <div class="bottom-row">
                        ...
                        <div class="tax-discount-row">
                            ...
                            <div class="form-field">
                                ...
                                <div class="discount-input-wrap">
                                    ...
                                    <input id="discount" name="discount_amount" type="number" min="0"
                                        step="0.01"
                        ...
                        <div class="form-field">
                            ...
                            <label for="attachment" class="attachment-box" id="attachment-box">
                            ...
                            @if ($invoice->attachment)
                                <div class="attachment-actions" id="current-attachment-actions">
                                    ...
                                    <button type="button" class="remove-attachment-btn"
                                        id="remove-attachment-btn">Remove Attachment</button>
                    ...
                    <div class="card-actions">
                        ...
                        <button class="btn btn-draft" type="submit" name="status" value="Draft">Save
                            Draft</button>
                ...
                <form id="delete-invoice-form" action="{{ route('developer.invoices.destroy', $invoice) }}"
