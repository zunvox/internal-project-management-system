...
<div class="page">
    ...
    <div class="filter-row">
        <div class="status-tabs">
            ...
            <a href="{{ route('developer.invoices.index') }}" class="status-tab {{ !$status ? 'active' : '' }}">All Invoices
                <span class="tab-count">{{ $counts['all'] }}</span>
            </a>

            <a
                href="{{ route('developer.invoices.index',['status' => 'Draft']) }}" class="status-tab {{$status === 'Draft'? 'active' : ''}}">Draft
            ...
            <a href="{{ route('developer.invoices.index',['status' => 'Approved']) }}" class="status-tab {{$status === 'Approved' ? 'active' : ''}}">Approved
                            ...
                            <td class="col-action">
                                <div class="action-buttons">
                                    @if ($invoice->status === 'Draft')
                                        ...
                                        <a href="{{ route('developer.invoices.edit', $invoice) }}" class="action-link" title="Edit Invoice">

                                            <svg viewBox="0 0 24 24">
                                                <path d="M12 20h9"></path>
                                                <path d=" M16.5 3.5 a2.12 2.12 0 0 1 3 3 L7 19 l-4 1 1-4Z"></path>
                                            </svg>
                                        ...
                                        <form action="{{ route('developer.invoices.destroy', $invoice) }}" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this invoice?');">
                                            ...
                                            <button type="submit" class="action-link action-button" title="Delete Invoice">
                                                <svg viewBox="0 0 24 24">
                                    ...
                                    @else
                                        ...
                                        <a href="{{ route('developer.invoices.show',$invoice) }}" class="action-link" title="View Invoice">
                                            <svg viewBox="0 0 24 24">
                                                <path d="M2 12 s3.5-6 10-6 10 6 10 6 -3.5 6-10 6 S2 12 2 12Z"></path>
