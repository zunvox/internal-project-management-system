  ...
  <div class="board">
    ...
    <div class="column">
      ...
      <div class="column-scroll">
        ...
        <div class="project-card-link" data-project-id="{{ $project->id }}" data-search="{{ strtolower(
        $project->name . ' ' .
        ($project->description ?? '') . ' ' .
        $project->status . ' ' .
...
>
    ...
    <textarea
        ...
        placeholder="Write a project update... Press Enter to post"
        required
    ></textarea>
</form>
